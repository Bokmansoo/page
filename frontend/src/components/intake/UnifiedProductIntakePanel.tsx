...
type ClarificationOption = { id?: string; observation_id?: string; value?: string; label?: string };
type Clarification = { clarification_id: string; field_id?: string; label?: string; question?: string; allowed_options?: ClarificationOption[]; options?: ClarificationOption[]; observations?: ClarificationOption[] };
...
function ConfirmationQuestion({ question, answer, update }: { question: Clarification; answer: AnswerDraft; update: (id: string, update: Partial<AnswerDraft>) => void }) {
  const options = question.allowed_options || question.options || question.observations || [];
