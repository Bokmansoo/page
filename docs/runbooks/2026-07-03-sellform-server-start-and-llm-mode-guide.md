...
| 구성 요소 | 실행 위치 | 포트 | 환경 변수 |
| --- | --- | --- | --- |
| PostgreSQL | Docker Compose | `5544` | `SELLFORM_DATABASE_URL` |
| FastAPI 백엔드 | `C:\page` | `8001` | `NEXT_PUBLIC_API_BASE_URL=http://127.0.0.1:8001` |
| Next.js 프론트엔드 | `C:\page\frontend` | `3100` (E2E) / `3000` (dev) | — |

프론트엔드의 `NEXT_PUBLIC_API_BASE_URL`은 `.env.local`에서 설정한다.
...
```cmd
curl.exe -I http://127.0.0.1:8001/docs
```
